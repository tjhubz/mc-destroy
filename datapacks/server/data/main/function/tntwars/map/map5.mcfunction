...
tp @e[type=minecraft:armor_stand,tag=redSpawn] 41 10.1 156 135 0
tp @e[type=minecraft:armor_stand,tag=blueSpawn] -41 10.1 74 -45 0
tp @e[type=minecraft:armor_stand,tag=whiteSpawn] -41 10.1 156 -135 0
tp @e[type=minecraft:armor_stand,tag=yellowSpawn] 41 10.1 74 45 0
...
execute as @e[type=minecraft:armor_stand,tag=mapReset4] at @s run setblock ~ ~-1 ~ minecraft:structure_block[mode=load]{name:"tntwars5_map4",posX:0,posY:-32,posZ:0,rotation:"NONE",mirror:"NONE",mode:"LOAD"} replace
execute as @e[type=minecraft:armor_stand,tag=mapReset5] at @s run setblock ~ ~-1 ~ minecraft:structure_block[mode=load]{name:"tntwars5_map5",posX:0,posY:-32,posZ:0,rotation:"NONE",mirror:"NONE",mode:"LOAD"} replace
execute as @e[type=minecraft:armor_stand,tag=mapReset6] at @s run setblock ~ ~-1 ~ minecraft:structure_block[mode=load]{name:"tntwars5_map6",posX:0,posY:-32,posZ:0,rotation:"NONE",mirror:"NONE",mode:"LOAD"} replace
execute as @e[type=minecraft:armor_stand,tag=mapReset7] at @s run setblock ~ ~-1 ~ minecraft:structure_block[mode=load]{name:"tntwars5_map7",posX:0,posY:-32,posZ:0,rotation:"NONE",mirror:"NONE",mode:"LOAD"} replace
execute as @e[type=minecraft:armor_stand,tag=mapReset8] at @s run setblock ~ ~-1 ~ minecraft:structure_block[mode=load]{name:"tntwars5_map8",posX:0,posY:-32,posZ:0,rotation:"NONE",mirror:"NONE",mode:"LOAD"} replace
execute as @e[type=minecraft:armor_stand,tag=mapReset9] at @s run setblock ~ ~-1 ~ minecraft:structure_block[mode=load]{name:"tntwars5_map9",posX:0,posY:-32,posZ:0,rotation:"NONE",mirror:"NONE",mode:"LOAD"} replace
execute as @e[type=minecraft:armor_stand,tag=mapReset10] at @s run setblock ~ ~-1 ~ minecraft:structure_block[mode=load]{name:"tntwars5_map10",posX:0,posY:-32,posZ:0,rotation:"NONE",mirror:"NONE",mode:"LOAD"} replace
execute as @e[type=minecraft:armor_stand,tag=mapReset11] at @s run setblock ~ ~-1 ~ minecraft:structure_block[mode=load]{name:"tntwars5_map11",posX:0,posY:-32,posZ:0,rotation:"NONE",mirror:"NONE",mode:"LOAD"} replace
execute as @e[type=minecraft:armor_stand,tag=mapReset12] at @s run setblock ~ ~-1 ~ minecraft:structure_block[mode=load]{name:"tntwars5_map12",posX:0,posY:-32,posZ:0,rotation:"NONE",mirror:"NONE",mode:"LOAD"} replace
