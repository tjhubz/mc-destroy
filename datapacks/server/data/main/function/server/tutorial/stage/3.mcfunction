...
execute if entity @s[scores={tutorial=550}] at @s as @a[dx=30,dy=100,dz=30,team=tutorial] at @s run function main:server/tutorial/press_button
execute if entity @s[scores={tutorial=650}] at @s as @a[dx=30,dy=100,dz=30,team=tutorial] at @s run function main:server/tutorial/press_button
execute if entity @s[scores={tutorial=750}] at @s as @a[dx=30,dy=100,dz=30,team=tutorial] at @s run function main:server/tutorial/press_button
execute if entity @s[scores={tutorial=850}] at @s as @a[dx=30,dy=100,dz=30,team=tutorial] at @s run function main:server/tutorial/press_button
