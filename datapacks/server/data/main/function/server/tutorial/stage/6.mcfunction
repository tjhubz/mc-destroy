...
execute if entity @s[scores={tutorial=750}] at @s as @a[dx=30,dy=100,dz=30,team=tutorial] run function main:server/util/play_anvil_sound
...
execute if entity @s[scores={tutorial=810}] at @s as @a[dx=30,dy=100,dz=30,team=tutorial] run function main:server/util/play_anvil_sound
...
execute if entity @s[scores={tutorial=1150}] at @s as @a[dx=30,dy=100,dz=30,team=tutorial] run function main:server/util/play_anvil_sound
