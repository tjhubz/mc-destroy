...
execute if entity @s[scores={tutorial=103}] at @s as @a[dx=30,dy=100,dz=30,team=tutorial] run function main:server/util/play_anvil_sound
...
execute if entity @s[scores={tutorial=600}] at @s as @a[dx=30,dy=100,dz=30,team=tutorial] run function main:server/util/play_anvil_sound
...
execute if entity @s[scores={tutorial=603}] at @s as @a[dx=30,dy=100,dz=30,team=tutorial] run function main:server/util/play_anvil_sound
...
execute if entity @s[scores={tutorial=1004}] at @s as @a[dx=30,dy=100,dz=30,team=tutorial] run function main:server/util/play_anvil_sound
