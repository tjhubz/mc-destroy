tag @s add set
scoreboard players set *crossing settings 1
scoreboard players set *launching settings 1
scoreboard players set *bridges settings 1
execute if score *sheep_health settings matches 0 run scoreboard players set *sheep_health settings 25
execute if score *match_limit settings matches 0 run scoreboard players set *match_limit settings 15
scoreboard players set *respawning settings 1
scoreboard players set *deathmatch settings 5
scoreboard players set *build_period settings 2
scoreboard players set *sheep_glow settings 1
